...
{
    public class ContaCorrente : ContaBancaria, IMovimentacaoConta
    {
        private double TaxaManutencao { get; } = 0.1;

        public ContaCorrente(string nome, int numeroCel, int numRG, int CPF, double dinheiro) : base (nome, numeroCel, numRG, CPF, dinheiro)
        {
        }
